...
export function CommandPalette() {
  ...
  const commands: Command[] = useMemo(
    () => [
      ...
      {
        id: 'open-help',
        label: 'Help: Open the Loom Manual',
        hint: '⌘/',
        run: () => useHelp.getState().openHelp(),
      },
      {
        id: 'help-shortcuts',
        label: 'Help: Keyboard Shortcuts',
        run: () => useHelp.getState().openHelp('shortcuts'),
      },
      {
        id: 'help-cheat-sheet',
        label: 'Help: Loom Syntax Cheat Sheet',
        run: () => useHelp.getState().openHelp('cheat-sheet'),
      },
      {
        id: 'open-settings',

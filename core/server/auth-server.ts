...
import { AUTH_SECRET, BASE_URL, TRUSTED_ORIGINS } from "./config.ts";
...
export const auth = betterAuth({
  ...
  // One trusted-origin list shared with the router's CORS reflection
  // (config.ts). Extend via LOOM_TRUSTED_ORIGINS if needed.

...
[`loom-v3.html`](loom-v3.html).

> **Section references:** the `§N` citations below follow the canonical
> language spec, [`docs/loom-v3.html`](loom-v3.html). Anchor fragments in
> the links may not resolve exactly — use the spec's table of contents to
> find the cited section.
...
Writers don't need this doc — see `loom-v3.html` §2 for that.
...
sigils, triggers — see [design §11](loom-v3.html#11-extension-model)).
...
[design §12](loom-v3.html#12-implementation-notes)).
...
> [design §9.4](loom-v3.html#94-scenes). A slugline scene has no
...
[`loom-v3.html` §5.3](loom-v3.html#53-improvisation) for the
playback semantics.
...
[design §4](loom-v3.html#4-characters).
...
a slot. See [design §4.5](loom-v3.html#45-knowledge).
...
"Imperative control"). See [design §4.6](loom-v3.html#46-goals).
...
[design §4.3](loom-v3.html#43-disposition).
...
[design §4.8](loom-v3.html#48-hooks).
...
unlockable nodes). See [design §5](loom-v3.html#5-stats--progression).
...
[design §5.3](loom-v3.html#53-stats--four-types).
...
See [design §5.5](loom-v3.html#55-modifiers).
...
living system. See [design §9](loom-v3.html#9-reactivity--dynamics).
...
invocation. See [design §9.4](loom-v3.html#94-scenes).
...
(§12 / future §15). See
[design §9.6](loom-v3.html#96-procedural-text).
...
[design §9.5](loom-v3.html#95-list-comprehensions).
...
[design §9.7](loom-v3.html#97-spawning-and-joining).
...
The compiler lowers reactive `let` to a memoized reactive cell (the
Rust runtime uses a Memo-style primitive). See
[design §9.1](loom-v3.html#91-reactive-let).
...
document. See [design §10](loom-v3.html#10-factions).
...
[design §10.3](loom-v3.html#103-membership).
...
[design §10.4](loom-v3.html#104-collective-state).
...
mirror. See [design §10.2](loom-v3.html#102-stance).
...
[design §10.2.1](loom-v3.html#1021-believed-stance--the-information-asymmetry-layer).
...
[design §10.7](loom-v3.html#107-narrative-pattern-matching-against-emergent-factions).
...
joining onward. See
[design §10.8](loom-v3.html#108-live-performance-integration).
...
unlimited. See [design §10.6](loom-v3.html#106-templates-and-organic-emergence).
...
- **The bytecode / IR.** This is a source grammar. The compiled
  ...
  [`loom-v3.html` §12](loom-v3.html#12-implementation-notes).
